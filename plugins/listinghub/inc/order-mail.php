<?php
global $wpdb;			
	$email_body_cilent = get_option( 'listinghub_order_client_email');
	$order_email_subject_client = get_option( 'listinghub_order_client_email_sub');			
	...
	$dis_amount =get_user_meta($userId, 'listinghub_discount',true);
	
	$package_amount_2=$listinghub_package_cost.' '.$api_currency;
	$discount_2= $dis_amount.' '.$api_currency;
	$total_g =(int)$listinghub_package_cost - (int)$dis_amount;
	$total_g =(string)$total_g.' '.$api_currency;
	...
	// For Admin Email*****	
	$email_body_admin = get_option( 'listinghub_order_admin_email');
	$order_email_subject_admin = get_option( 'listinghub_order_admin_email_sub');			
