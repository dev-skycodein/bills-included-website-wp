		...
		<?php
					...
					$post_author_id= get_post_field( 'post_author', $id );		
						...
						$dir_data['locations']= $locations;								
						 if(get_post_meta($id,'latitude',true)!=''){
                        		$dir_data['lat']=get_post_meta($id,'latitude',true);
                        }
                        if(get_post_meta($id,'longitude',true)!=''){
			...
			if($dir_map_type=='google-map'){
				include( ep_listinghub_template. 'listing/map/google-map.php');

			}else{  
				include( ep_listinghub_template. 'listing/map/openstreet-map.php');
			}
