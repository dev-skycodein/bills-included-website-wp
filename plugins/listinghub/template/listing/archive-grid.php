		...
		<div class="container-fluid "  >
			...
			<div class="row" id="full_grid"> 
							...
							<div class="listing-top-layout">
								<?php
									if(isset($active_archive_fields['top_search_form'])){
										...
										if($search_form_setting=='popup'){
									?>													
										<button type="button" class="btn btn-big mb-2"  onclick="listinghub_call_filter()">
								...
								?>
								<ul class="mr-3">
									<li class="topicon-border hide-on-mobile"><a class="active lx-grid-one grid-one " href="#" data-placement="top" data-toggle="tooltip"  title="<?php  esc_html_e('Map Large','listinghub'); ?>"><i class="fa-solid fa-grip-vertical" aria-hidden="true"></i></a></li>
									<li class="topicon-border hide-on-mobile"><a class="lx-grid-two grid-two" href="#" data-placement="top" data-toggle="tooltip"  title="<?php  esc_html_e('Map Half','listinghub'); ?>" >
										<i class="fa-solid fa-grip" aria-hidden="true"></i>
									</a></li>
									<li class="topicon-border hide-on-mobile"><a class="lx-grid-three grid-three " href="#" data-placement="top" data-toggle="tooltip"  title="<?php  esc_html_e('Full Page','listinghub'); ?>"><i class="fas fa-expand-arrows-alt" aria-hidden="true"></i></a></li>
									<?php
										if( $listinghub_filter_badge>0 ){
										?>	
				...
				<div class=" col-md-6 col-lg-6 col-sm-12 " id="archivemap">
					<?php include(ep_listinghub_template.'listing/map/map.php'); ?>
				</div>
			</div>
		</div>
	</section>
