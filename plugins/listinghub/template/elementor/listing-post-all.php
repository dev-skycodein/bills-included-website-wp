...
namespace Elementor;
use WP_Query;
class listinghub_Recent_Posts_Widget extends Widget_Base {

	public function get_name() {

		return 'listinghub_recent_post';
	}

	public function get_title() {
		return esc_html__( 'All Listings + Map', 'listinghub' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'All Listing: Right Map', 'listinghub' ),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_listinghub_post_categories(),			
			]
		);
		$this->add_control(
			'locations',
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_listinghub_post_locations(),			
			]
		);
		$this->add_control(
			'tag',
			[
				...
				'label_block' => true,
				'multiple'    => true,
				'options'     => ep_listinghub_post_tag(),			
			]
		);
	...
	protected function render() {
		...
		$shortcode ="[listinghub_archive_grid ".$atts." ]";		
...
Plugin::instance()->widgets_manager->register( new listinghub_Recent_Posts_Widget );
//Post Category
function ep_listinghub_post_categories() {
...
//Post tag
function ep_listinghub_post_tag() {
	$listinghub_directory_url=get_option('ep_listinghub_url');
	if($listinghub_directory_url==""){$listinghub_directory_url='listing';}
...
//Post locations
function ep_listinghub_post_locations() {
	$listinghub_directory_url=get_option('ep_listinghub_url');
	if($listinghub_directory_url==""){$listinghub_directory_url='listing';}
