...
if (!class_exists('wp_admin_notifications')) {
	class wp_admin_notifications   { 
	   ...
	   * @param $include
	   */
	  static function listinghub_register_notification($id, $msg = '', $type = 'warning', $pages = array(), $include = true) {
	   ...
	   * @param $id
	   */
	  static function listinghub_display_notification($id) {
	  	$notifications = get_option('wp_admin_notifications', array());
	   ...
	   */
	  static function listinghub_display_notifications() {

	  	$notifications = get_option('wp_admin_notifications', array());

	  	foreach($notifications as $notification) {
	  		if ($notification['active']) {
	  			self::listinghub_display_notification($notification['id']);
	  		}
	  	}
	  }
	  ...
	  static function load() { 
	  	add_action('admin_notices', 'wp_admin_notifications::listinghub_display_notifications');
	  }
	}
}
